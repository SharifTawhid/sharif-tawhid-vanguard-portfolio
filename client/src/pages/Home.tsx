...
const forageCertificates = [
  { number: "01", title: "Marketing Explorer", image: "/manus-storage/marketing-explorer-certificate.png", pdf: "/manus-storage/marketing-explorer-certificate.pdf", label: "Marketing Explorer Job Simulation", skills: "Creative Strategy / Performance Analysis / Customer & Product Marketing / Digital Marketing", description: "A hands-on exploration of how creative thinking, performance analysis and customer understanding connect to modern marketing decisions." },
  { number: "02", title: "Product Management", image: "/manus-storage/product-management-certificate.png", pdf: "/manus-storage/product-management-certificate.pdf", label: "Product Management Job Simulation", skills: "Product Performance / Stakeholder Presentation Planning", description: "An opportunity to approach growth from a product perspective — understanding performance, structuring insights and communicating decisions to stakeholders." },
  { number: "03", title: "Omnichannel Marketing", image: "/manus-storage/omnichannel-marketing-certificate.png", pdf: "/manus-storage/omnichannel-marketing-certificate.pdf", label: "Omnichannel Marketing Job Simulation", skills: "Integrated Marketing Planning / Digital Retail Experience / Local Ambassador Strategy / Data Analysis", description: "A practical exploration of how digital, customer experience, local activation and data can work together inside an integrated marketing system." },
];
const reports = [
...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section className="forage-section section-pad"><div className="section-intro"><p className="section-index">02.5 / Practical work</p><h2>Practical work.<br /><em>Not just theory.</em></h2><p className="section-desc">Three industry-focused job simulations completed through Forage, an international platform connecting learners with practical work experiences from leading organizations.</p></div><div className="forage-lede"><p>These experiences expanded my work beyond campaign execution — into strategy, analysis, product thinking, customer experience and integrated marketing.</p><span>FORAGE / International Work Experience Platform</span></div><div className="forage-grid">{forageCertificates.map((certificate) => <article className="forage-card" key={certificate.title}><div className="forage-card-meta"><span>{certificate.number} — {certificate.title}</span><a href={releaseHref(certificate.pdf)} download target="_blank" rel="noreferrer">Download certificate <ArrowUpRight size={14} /></a></div><a className="certificate-image" href={releaseHref(certificate.pdf)} target="_blank" rel="noreferrer"><img src={rawHref("forage", certificate.image)} alt={`${certificate.label} certificate`} loading="lazy" /></a><div className="forage-card-copy"><h3>{certificate.label}</h3><p className="forage-skills"><strong>Practical experience across:</strong> {certificate.skills}</p><p>{certificate.description}</p></div></article>)}</div><div className="forage-close"><p>These weren’t simply certificates collected for a résumé.</p><p>They represent completed practical job simulations designed around real-world professional tasks, adding another layer to my experience across marketing, performance, strategy, analytics and product thinking.</p></div></section>
